...
.directive('drawer', ['$rootScope', '$ionicGesture','$ionicPlatform', function($rootScope, $ionicGesture,$ionicPlatform) {
  return {
    restrict: 'E',
    ...
    link: function($scope, $element, $attr, ctrl) {
      ...
      $scope.openDrawer = function() {
        console.log('open');
        ctrl.open();
         $scope.back= $ionicPlatform.registerBackButtonAction(function(event){
        ...
        $rootScope.closeDrawer,$scope.closeDrawer = function() {
        console.log('close');
        ctrl.close();
          $scope.back();
      };
